...
if [ -z "${CXX_GENERATOR_ROOT+aaa}" ]; then
    CXX_GENERATOR_ROOT="$COCOS_CONSOLE_ROOT/../../bindings-generator"
fi
...
LD_LIBRARY_PATH=${CXX_GENERATOR_ROOT}/libclang $PYTHON_BIN ${CXX_GENERATOR_ROOT}/generator.py ${PWD}/cocos2dx_smartfish.ini -t spidermonkey -s testandroid -o ${PWD}/frameworks/runtime-src/Classes/scripting/generated
